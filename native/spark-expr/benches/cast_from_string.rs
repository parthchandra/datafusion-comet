...
fn criterion_benchmark(c: &mut Criterion) {
    ...
    for (mode, mode_name) in [
        ...
        let cast_to_i8 = Cast::new(expr.clone(), DataType::Int8, spark_cast_options.clone(), None);
        let cast_to_i16 = Cast::new(expr.clone(), DataType::Int16, spark_cast_options.clone(), None);
        let cast_to_i32 = Cast::new(expr.clone(), DataType::Int32, spark_cast_options.clone(), None);
        let cast_to_i64 = Cast::new(expr.clone(), DataType::Int64, spark_cast_options, None);
