...
fn criterion_benchmark(c: &mut Criterion) {
    ...
    let cast_i32_to_i8 = Cast::new(expr.clone(), DataType::Int8, spark_cast_options.clone(), None);
    let cast_i32_to_i16 = Cast::new(expr.clone(), DataType::Int16, spark_cast_options.clone(), None);
    let cast_i32_to_i64 = Cast::new(expr, DataType::Int64, spark_cast_options, None);
