...
public final class Native extends NativeBase {
   ...
   *
   * @param array the Java int array to export
   * @return memory address of the exported array (as a long pointer)
   */
  public static native long exportIntArray(int[] array);

  /**
   * Exports a Java long array to native Rust memory and returns a pointer to the exported array.
   * The array data is copied to Rust-managed memory and must be freed using freeExportedLongArray.
   *
   * @param array the Java long array to export
   * @return memory address of the exported array (as a long pointer)
   */
  public static native long exportLongArray(long[] array);

  /**
   * Exports a Java double array to native Rust memory and returns a pointer to the exported array.
   * The array data is copied to Rust-managed memory and must be freed using
   * freeExportedDoubleArray.
   *
   * @param array the Java double array to export
   * @return memory address of the exported array (as a long pointer)
   */
  public static native long exportDoubleArray(double[] array);

  /**
   * Exports a Java String array to native Rust memory and returns a pointer to the exported array.
   * The strings are converted to Rust String objects and must be freed using
   * freeExportedStringArray.
   *
   * @param array the Java String array to export
   * @return memory address of the exported array (as a long pointer)
   */
  public static native long exportStringArray(String[] array);

  /**
   * Frees a Rust-managed int array that was previously exported from Java.
   *
   * @param ptr the memory address returned by exportIntArray
   */
  public static native void freeExportedIntArray(long ptr);

  /**
   * Frees a Rust-managed long array that was previously exported from Java.
   *
   * @param ptr the memory address returned by exportLongArray
   */
  public static native void freeExportedLongArray(long ptr);

  /**
   * Frees a Rust-managed double array that was previously exported from Java.
   *
   * @param ptr the memory address returned by exportDoubleArray
   */
  public static native void freeExportedDoubleArray(long ptr);

  /**
   * Frees a Rust-managed String array that was previously exported from Java.
   *
   * @param ptr the memory address returned by exportStringArray
   */
  public static native void freeExportedStringArray(long ptr);
